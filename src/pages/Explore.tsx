  ...
  return (
    <div className="max-w-4xl mx-auto p-4 space-y-6">
      ...
      <div className="relative">
        ...
        <Input placeholder="Search users, posts, tags..." value={search} onChange={e => setSearch(e.target.value)} className="pl-10" />
      </div>
      ...
      <div>
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {filtered.map((u, i) => (
              <motion.div key={u.id} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.05 }} className="glass rounded-xl p-4 flex items-center gap-3 hover:border-primary/30 transition-all">
